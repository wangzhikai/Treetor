...
public abstract class ProfilableAbstractQueuedSynchronizer
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         */
        final boolean isOwnedBy(ProfilableAbstractQueuedSynchronizer sync) {
            return sync == ProfilableAbstractQueuedSynchronizer.this;
        }
...
//		}
        try {
        	//REF:	//http://fujinbing.iteye.com/blog/695923
            ...
            stateOffset = unsafe.objectFieldOffset
                (ProfilableAbstractQueuedSynchronizer.class.getDeclaredField("state"));
            headOffset = unsafe.objectFieldOffset
                (ProfilableAbstractQueuedSynchronizer.class.getDeclaredField("head"));
            tailOffset = unsafe.objectFieldOffset
                (ProfilableAbstractQueuedSynchronizer.class.getDeclaredField("tail"));
