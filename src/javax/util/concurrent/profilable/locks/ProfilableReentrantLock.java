...
public class ProfilableReentrantLock implements Lock,Profilable, java.io.Serializable {
    ...
    abstract static class Sync extends ProfilableAbstractQueuedSynchronizer {
        protected Sync(long lockId, long profiableId) {
        	
			super(lockId,profiableId);
    ...
    static final class NonfairSync extends Sync {
        ...
        public NonfairSync(long lockId, long profiableId) {
    ...
    static final class FairSync extends Sync {
        protected FairSync(long lockId, long profiableId) {
    ...
    public ProfilableReentrantLock() {
		...
		sync = new NonfairSync(lockId, profiableId);
		try {
			GraphMessenger.messageque.put(
    ...
    public ProfilableReentrantLock(boolean fair) {
        ...
        sync = fair ? new FairSync(lockId,profiableId) : new NonfairSync(lockId,profiableId);
		try {
			GraphMessenger.messageque.put(
					new MessageForGraph(FunctorType.createARNodeforProfilable,
							this.getProfiableId(),lockId ));
...
//			}
    ...
    public boolean hasWaiters(Condition condition) {
        ...
        if (!(condition instanceof ProfilableAbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.hasWaiters((ProfilableAbstractQueuedSynchronizer.ConditionObject)condition);
    }
    ...
    public int getWaitQueueLength(Condition condition) {
        ...
        if (!(condition instanceof ProfilableAbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitQueueLength((ProfilableAbstractQueuedSynchronizer.ConditionObject)condition);
    }
    ...
    protected Collection<Thread> getWaitingThreads(Condition condition) {
        ...
        if (!(condition instanceof ProfilableAbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitingThreads((ProfilableAbstractQueuedSynchronizer.ConditionObject)condition);
    }
